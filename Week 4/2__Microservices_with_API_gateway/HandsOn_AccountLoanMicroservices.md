# Hands on: Account and Loan Microservices
...
public class AccountController {
    ...
    public Account getAccount(@PathVariable String number) {
        // Dummy response - no DB connectivity needed
...
**Why different ports?** Both Spring Boot apps default to 8080. The loan service uses
`server.port=8081` so both can run simultaneously without conflict.
